...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnexpectedError&&(identical(other.data, data) || other.data == data));
}
...
$UnexpectedErrorDtoCopyWith<$Res>? get data {
  ...
  return $UnexpectedErrorDtoCopyWith<$Res>(_self.data!, (value) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnProcessableRequest&&(identical(other.httpCode, httpCode) || other.httpCode == httpCode)&&(identical(other.data, data) || other.data == data));
}


@override
int get hashCode => Object.hash(runtimeType,httpCode,data);
...
/// Create a copy of DataException
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? httpCode = null,Object? data = null,}) {
...
$UnProcessableRequestDtoCopyWith<$Res> get data {
  ...
  return $UnProcessableRequestDtoCopyWith<$Res>(_self.data, (value) {
    return _then(_self.copyWith(data: value));
  });
}
}
